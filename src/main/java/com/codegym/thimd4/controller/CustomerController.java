package com.codegym.thimd4.controller;

import com.codegym.thimd4.model.Customer;
import com.codegym.thimd4.service.ICustomerService;
...
public class CustomerController {
    ...
    @PostMapping("/update")
    public ModelAndView updateCustomer(@ModelAttribute("customer") Customer customer, BindingResult bindingResult) {
        customerValidator.validate(customer, bindingResult);
        if (bindingResult.hasErrors()) {
            ModelAndView modelAndView = new ModelAndView("/customer/update");
            modelAndView.addObject("customer", customer);
